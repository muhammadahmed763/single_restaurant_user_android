...
class FeaturedAdapter(
    ...
    inner class FeaturedViewHolder(private val binding: RowFeaturedBinding) :
        ...
        fun bindItems(
            ...
            if (data.isFavorite == 1) {
                binding.ivwishlist.background = ResourcesCompat.getDrawable(context.resources, R.drawable.ic_fav, null)
    ...
    override fun onBindViewHolder(holder: FeaturedViewHolder, position: Int) {
        holder.bindItems(context, featuredList[position], itemClick, position)
    }
